...
// use streamForm component for reduxform
...
// onsubmit takes in the formvalues that are in the field inputs such as value and name
     onSubmit = (formValues) =>{
...
// after hooking up reduxform, connect needs to be connected to the component, you do that by creating a variable to make it cleaner
